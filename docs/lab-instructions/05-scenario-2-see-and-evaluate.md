...
✅ **Checkpoint:** You have a Mermaid diagram showing your deployed resources with connection arrows. To render it: copy the Mermaid block from Copilot's output and paste into [mermaid.live](https://mermaid.live) or use VS Code with a Mermaid extension.
